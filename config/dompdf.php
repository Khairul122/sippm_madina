...
return [
    ...
    */
    ...
    // Resolved explicitly via public_path() instead of relying on the
    // package default (base_path('public')), because this app's public/
    // directory is deployed separately from the app core on shared
    // hosting (see deploy.yml) and $app->usePublicPath() only repoints
    // public_path(), not base_path() — leaving this null makes dompdf
    // look for a public/ folder inside the app core that doesn't exist
    // on the server, throwing "Cannot resolve public path".
