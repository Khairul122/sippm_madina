...
<div class="sipapa-card-raised p-4 mb-4" x-data="{ files: [] }">
    <div class="border-bottom pb-2 mb-4 d-flex align-items-center gap-2">
        <i class="bi bi-calendar-plus text-sipapa fs-4"></i>
    ...
    <form method="post" action="{{ url('/dashboard/activities') }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <div class="file-upload-zone">
                ...
                <p class="mb-1 fw-semibold text-sipapa">Seret foto dokumentasi ke sini atau klik untuk memilih</p>
        ...
        <div class="border-top pt-3 d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-sipapa btn-sm px-4 rounded-3 fw-semibold">Simpan Kegiatan</button>
        </div>
    </form>
</div>
