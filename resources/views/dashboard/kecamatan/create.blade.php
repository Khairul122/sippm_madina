...
<div class="sippm-card-raised p-4 mb-4" style="max-width:560px;">
    ...
    <form method="post" action="{{ url('/dashboard/kecamatan') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="Contoh: Panyabungan">
        </div>
        <div class="mb-4">
            <label class="form-label">Kode</label>
            <input type="text" name="code" class="form-control" value="{{ old('code') }}" required placeholder="Contoh: PYB">
        </div>
