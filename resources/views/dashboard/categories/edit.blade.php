...
<div class="sipapa-card-raised p-4 mb-4">
    <div class="border-bottom pb-2 mb-4 d-flex align-items-center gap-2">
        <i class="bi bi-tag-fill text-sipapa fs-4"></i>
        <h2 class="h5 mb-0 font-weight-bold" style="font-family: 'Poppins', sans-serif;">Ubah Kategori</h2>
    </div>
    <form method="post" action="{{ url('/dashboard/categories/'.$category->id) }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" class="form-control" value="{{ old('name', $category->name) }}" required placeholder="Contoh: Infrastruktur, Kesehatan, Pendidikan...">
        </div>
