...
<div class="container-fluid py-2">
    ...
    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3 mb-4">
        <div>
            <h1 class="h3 mb-1 fw-bold text-dark" style="font-family: 'Poppins', sans-serif; color: var(--sipapa-navy) !important;">Kinerja Pelayanan</h1>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100 stat-card" style="border-radius: var(--sipapa-radius-lg); border-left: 4px solid var(--sipapa-navy) !important;">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    ...
                    <div class="stat-icon-box bg-navy-subtle text-navy rounded-circle d-flex align-items-center justify-content-center" style="width: 52px; height: 52px; background-color: rgba(22, 52, 92, 0.08); color: var(--sipapa-navy);">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100 stat-card" style="border-radius: var(--sipapa-radius-lg); border-left: 4px solid var(--sipapa-green) !important;">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    ...
                    <div class="stat-icon-box bg-success-subtle text-success rounded-circle d-flex align-items-center justify-content-center" style="width: 52px; height: 52px; background-color: rgba(46, 125, 79, 0.08); color: var(--sipapa-green);">
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0 text-dark" style="font-family: 'Poppins', sans-serif; font-size: 1.8rem; color: var(--sipapa-gold) !important;">{{ $resolutionRate }}%</h3>
                        </div>
                        <div class="stat-icon-box bg-gold-subtle text-gold rounded-circle d-flex align-items-center justify-content-center" style="width: 52px; height: 52px; background-color: rgba(201, 162, 39, 0.08); color: var(--sipapa-gold);">
                            <i class="bi bi-speedometer2 fs-4"></i>
                        </div>
                    </div>
                    <!-- Elegant Progress Bar -->
                    <div class="progress" style="height: 6px; background-color: rgba(201, 162, 39, 0.1); border-radius: 10px;">
                        <div class="progress-bar" role="progressbar" style="width: {{ $resolutionRate }}%; background-color: var(--sipapa-gold); border-radius: 10px;" aria-valuenow="{{ $resolutionRate }}" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
        </div>
