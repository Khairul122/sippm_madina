...
@section('content')
<div class="sipapa-card-raised p-4 mb-4" x-data="{ role: '' }">
    <div class="border-bottom pb-2 mb-4 d-flex align-items-center gap-2">
        <i class="bi bi-person-plus-fill text-sipapa fs-4"></i>
    ...
    <form method="post" action="{{ url('/dashboard/users') }}">
        ...
        <div class="border-top pt-3 d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-sipapa btn-sm px-4 rounded-3 fw-semibold">Simpan Pengguna</button>
        </div>
    </form>
</div>
@endsection
